	...
	public AchievementsDisplay(User user) 
	{
			...
			boolean found = userAchievements.contains(achievementNames.get(i));
			{
				if(found){
					...
					else if (name.equals("OvershootingTheMoon"))
					{
						...
						newLabel.setToolTipText("<html>"
		                        +"You collected all hearts and the Queen of Spades not once,"
		                        +"<br>"
		                        +"not twice, but three times! Amazing! You've probably sunk"
		                        +"<br>"
		                        +"way too much time in this game by now, but hey... at least you"
		                        +"<br>"
		                        +"got this achievement as a record of your accomplishment. Now go"
		                        +"<br>"
					...
					else if (name.equals("BrokenHeart"))
					{
						...
						newLabel.setFont(new Font("Tahoma", Font.PLAIN, 14));
						newLabel.setToolTipText("<html>"
		                        +"So you won all the hearts in one round but the Queen"
		                        +"<br>"
		                        +"(of Spades) got away. Sorry about that. Cheer up though, "
		                        +"<br>"
		                        +"there are plenty of other cards in the pile. You'll love again."
		                   + "</html>");
						contentPane.add(newLabel);
					}
					else if (name.equals("ShootingTheMoon"))
					{
						...
						newLabel.setFont(new Font("Tahoma", Font.PLAIN, 14));
						newLabel.setToolTipText("<html>"
		                        +"So you won all the hearts and the Queen (of Spades) in"
		                        +"<br>"
		                        +"one round. Congratulations. You showed those opponents"
		                        +"<br>"
		                        +"who's boss and collected zero points as your reward."
		                   + "</html>");
						contentPane.add(newLabel);
					}
					else if (name.equals("PassingTheBuck"))
					{
						...
						newLabel.setFont(new Font("Tahoma", Font.PLAIN, 14));
						newLabel.setToolTipText("<html>"
		                        +"You passed the Queen of Spades to another player..."
		                        +"<br>"
					...
					else if (name.equals("StartTheParty"))
					{
						...
						newLabel.setFont(new Font("Tahoma", Font.PLAIN, 14));
						newLabel.setToolTipText("<html>"
		                        +"You started a round by playing the Deuce of Clubs."
		                        +"<br>"
		                        +"If you could have started with anything else, you"
		                        +"<br>"
		                        +"must have reprogrammed the game...");
						contentPane.add(newLabel);
					}
					else if (name.equals("HatTrick"))
					{
						...
						newLabel.setFont(new Font("Tahoma", Font.PLAIN, 14));
						newLabel.setToolTipText("<html>"
		                        +"You collected all four cards on the table by playing"
		                        +"<br>"
		                        +"the highest one. You seriously would have shown more skill"
		                        +"<br>"
		...
		for(String achi : unCompletedA){
			...
			if (achi.equals("BrokenHeart"))
			{
				...
				achiDesc.setFont(new Font("Tahoma", Font.PLAIN, 14));
				achiDesc.setToolTipText("<html>"
                        +"Get all the hearts but miss the Queen of Spades"
                        +"<br>"
                        +"Otherwise known as really bad luck."
                        +"<br>"
                        +"<b>(One card short of Shooting The Moon)</b>"
                   + "</html>");
			...
			if (achi.equals("ShootingTheMoon"))
			{
				...
				achiDesc.setFont(new Font("Tahoma", Font.PLAIN, 14));
				achiDesc.setToolTipText("<html>"
                        +"Get the Queen of Spades and every heart"
                        +"<br>"
                        +"suited card in a round. Do this and you'll"
                        +"<br>"
                        +"be gifting these points to everyone but yourself."
                   + "</html>");
				contentPane.add(achiDesc);
			}
			if (achi.equals("PassingTheBuck"))
			{
				...
				achiDesc.setFont(new Font("Tahoma", Font.PLAIN, 14));
				achiDesc.setToolTipText("<html>"
                        +"Pass the Queen of Spades when it's time to"
                        +"<br>"
                        +"pass cards. Now she's somebody else's problem."
                        +"<br>"
                        +"Stay sharp!"
                   + "</html>");
				contentPane.add(achiDesc);
			...
			if (achi.equals("StartTheParty"))
			{
				...
				achiDesc.setFont(new Font("Tahoma", Font.PLAIN, 14));
				achiDesc.setToolTipText("<html>"
                        +"Get the Deuce of Clubs and play it to start a round."
                        +"<br>"
                        +"Not that you have the option of starting with anything else."
                   + "</html>");
				contentPane.add(achiDesc);
			}
			if (achi.equals("HatTrick"))
			{
				...
				achiDesc.setFont(new Font("Tahoma", Font.PLAIN, 14));
				achiDesc.setToolTipText("<html>"
                        +"Collect a trick (all four cards on the table) by playing a"
                        +"<br>"
                        +"higher card than the first suit played. Super easy stuff here."
                   + "</html>");
				contentPane.add(achiDesc);
			}
			...
			if (achi.equals("OvershootingTheMoon") && shot2 == true) //None earned
			{
				JLabel achiDesc = new JLabel("Overshooting The Moon");
				achiDesc.setFont(new Font("Tahoma", Font.PLAIN, 14));
				achiDesc.setToolTipText("<html>"
                        +"Collect all hearts and the Queen of Spades to Shoot The Moon"
                        +"<br>"
                        +"once. Then do it again. You're still not done. Shoot the Moon "
                        +"<br>"
                        +"for a third time and show it who's boss!"
                   + "</html>");
				contentPane.add(achiDesc);
			}
			if (shotOnce == true) //OvershootingTheMoon1 earned
			{
				...
				achiDesc.setToolTipText("<html>"
                        ...
                        +"for a third time and show it who's boss!"
                        +"<br>"
                        +"<b>(You've Shot the Moon one time. Just two more to go!)</b>"
                   + "</html>");
				contentPane.add(achiDesc);
				shotOnce = false;
			}
			if (shotTwice == true) //OvershootingTheMoon2 earned
			{
				...
				achiDesc.setToolTipText("<html>"
                        ...
                        +"for a third time and show it who's boss!"
                        +"<br>"
                        +"<b>(You've Shot the Moon twice now. Just one more time left!)</b>"
                   + "</html>");
				contentPane.add(achiDesc);
				shotTwice = false;
			}
